...
public class Orden {
	...
	public Orden(String nombre, String telefono, String direccion, String descripcion, String estado,
	...
	public Orden(int id, String nombre, String telefono, String direccion, String descripcion, String estado,
			String electrodomestico, LocalDate fechaSolicitud, LocalDate fechaActualizacion) {
		this.id = id;
		this.nombre = nombre;
		this.telefono = telefono;
